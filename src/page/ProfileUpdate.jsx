          ...
          <form onSubmit={updateUser} encType="multipart/form-data">
            ...
            <div className="relative ">
              ...
              <label htmlFor="avatar">
                <GoPencil
                  className="absolute -bottom-[50px] left-[130px] text-4xl text-black rounded-full cursor-pointer bg-white p-1 shadow-2xl"
                  id="avatar"
                />
              </label>
            </div>
            <div className="p-4 text-white">
              <div className="mt-14 flex flex-col gap-4 text-white">
                <div>
                  ...
                  <input
                    type="text"
                    name="name"
                    className="outline-none mt-3  text-md  bg-transparent w-full border border-opacity-30 border-solid border-white py-3 px-2 rounded-md text-white hover:border-blue-500 focus:border-blue-500"
                    value={formData.name}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    name="username"
                    className="mt-3 outline-none  text-md  bg-transparent w-full border border-opacity-30 border-solid border-white py-3 px-2 rounded-md text-white hover:border-blue-500 focus:border-blue-500"
              ...
              <div className="flex mt-10 justify-end w-full">
                <button
                  type="submit"
                  className="rounded-full px-8 text-lg py-1  text-black bg-white border border-solid  border-white  hover:bg-transparent hover:text-white transition-all"
                >
                  Edit
                </button>
              </div>
