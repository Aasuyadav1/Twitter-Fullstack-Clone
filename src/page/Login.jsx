            ...
            <form class="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  name="email"
                  id="email"
                  class="bg-gray-50 border  sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
