            ...
            <div className="flex-1 px-4 py-2 m-2">
              <div className="float-right">
                {!initialState.userData ||
                  (list._id !== initialState.userData._id && (
                    <button
                      onClick={() => followUser(list._id)}
                      className={`rounded-full px-4 text-sm py-1 text-black border-white border border-solid ${
                        initialState.userData &&
                        initialState.userData.following.includes(list._id)
