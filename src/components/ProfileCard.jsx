            ...
            <div className="p-4">
                ...
                <div className="space-y-1 justify-center w-full mt-3 ml-3">
                    ...
                    <div className="pt-3 flex justify-start items-start w-full divide-x divide-gray-800 divide-solid">
                        <div className="text-center pr-3"><span className="font-bold text-white">{user?.following.length}</span><span onClick={() => navigate(`/user/follow/${user?._id}`)}className="text-gray-600 cursor-pointer"> Following</span></div>
                        <div className="text-center px-3"><span className="font-bold text-white">{user?.followers.length} </span><span onClick={() => navigate(`/user/followers/${user?._id}`)}className="text-gray-600 cursor-pointer"> Followers</span></div>
                    </div>
                </div>
            </div>
