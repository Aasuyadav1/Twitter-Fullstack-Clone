...
const Navbar = () => {
    ...
    return (
        <header className="text-white h-auto py-4 hidden md:block">
            {/* Navbar (left side) */}
                ...
                <div className="overflow-y-auto fixed h-screen pr-3" style={{ width: '275px' }}>
                   ...
                   <svg viewBox="0 0 24 24" className="h-8 w-8 text-white ml-3" fill="currentColor">
                    ...
                    <nav className="mt-5 px-2">
                        <Link to={'/'}  className="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-gray-800 hover:text-blue-300">
                            <svg className="mr-4 h-6 w-6 " stroke="currentColor" fill="none" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l9-9 9 9M5 10v10a1 1 0 001 1h3a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1h3a1 1 0 001-1V10M9 21h6"></path>
                            </svg>
                            Home
                        </Link>
                        <Link  class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-gray-800 hover:text-blue-300">
            ...
            </Link>
            {
                initialState?.userData && initialState?.userData?._id ? (
                    <Link to={`/profile/${initialState.userData._id}`}  class="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-gray-800 hover:text-blue-300">
                <svg class="mr-4 h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
