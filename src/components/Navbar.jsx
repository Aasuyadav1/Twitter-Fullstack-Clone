...
const Navbar = () => {
    ...
    return (
        <header className="text-white h-auto py-4 hidden md:block">
            ...
            <div style={{ width: '275px' }} >
                <div className="overflow-y-auto fixed h-screen pr-3" style={{ width: '275px' }}>
                    ...
                    <nav className="mt-5 px-2">
                        <Link  className="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-gray-800 hover:text-blue-300">
            ...
            <Link  class="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full bg-gray-800 text-blue-300">
                <svg class="mr-4 h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
                ...
                Tweet
                    ...
                    <div className="absolute" style={{ bottom: '2rem' }}>
                        <div className="flex-shrink-0 flex hover:bg-gray-800 rounded-full px-4 py-3 mt-12 mr-2">
                            <Link  className="flex-shrink-0 group block">
